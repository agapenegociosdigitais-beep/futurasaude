...
export default function PagamentoContent() {
  ...
  useEffect(() => {
        if (!beneficiarioId) {
                setError('ID do beneficiario nao encontrado');
        }
  }, [beneficiarioId]);
        ...
        <>
              ...
              <div className="page-container">
                      <div className="card-wrapper">
                                <div className="title">Realizar Pagamento</div>div>
                                <div className="subtitle">Cartao Futura Saude - Plano Anual</div>div>
                      
                                <div className="price">
                                            R$ 99,90 <span>/ano</span>span>
                                </div>div>
                      ...
                      <>
                                    <button
                                      ...
                                      {loading ? (
                                                                        <>
                                                                                            <span className="loading"></span>span> Gerando pagamento...
                                                                        </>>
                                                                      ) : (
                                                                        'Pagar com PIX'
                                                                      )}
                      ...
                      <>
                        {pagamentoData.pixQrCode && (
                                        <div className="pix-container">
                                                          ...
                                                          <div className="pix-code">{pagamentoData.pixCopyPaste}</div>div>
